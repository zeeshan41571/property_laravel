                                            ...
                                            <table class="table" style="width: 100%">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><input type="time" name="departure_time" id=""></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                            ...
                                            <table class="table">
                                                <div id="guestContainer">
                                                    <div class="guest-info" data-guest="1">
                                                        ...
                                                        <div class="line">
                                                            <input type="text" name="guestStreet[]" placeholder="Street">
                                                            <input type="text" name="guestStreet1[]" placeholder="Street 1">
                                                            <input type="text" name="guestStreet2[]" placeholder="Street 2">
                        ...
                        <script>
                            $(document).ready(function() {
                                ...
                                $(document).on('change', '.documentType', function() {
                                    ...
                                    var documentUploads = $(this).closest('.guest-info').find('.documentUploads');
                                    var documentLabel1 = documentUploads.find('.documentLabel1');
                                    var documentLabel2 = documentUploads.find('.documentLabel2');
                                    var documentImage2 = documentUploads.find('.documentImage2');
                                    
                                    if (documentType === 'Passport') {
                                        documentLabel1.text('Passport Image');
                                        documentImage2.hide().prop('required', false);
                                        documentLabel2.hide();
                                    } else {
                                        documentLabel1.text('Document Image Front');
                                        documentLabel2.text('Document Image Back');
                                        documentImage2.show().prop('required', true);
                                        documentLabel2.show();
                                    }
                                });
                                let guestCount = 1;
                                    ...
                                    const guestInfoHtml = `
                                        <div class="guest-info" data-guest="${guestCount}">
                                            <div class="line">
                                                ...
                                                <input type="text" name="guestSurName[]" placeholder="Surname" required>
                                                <input type="email" name="guestEmail[]" placeholder="Email" required>
                                                <input type="tel" name="guestPhone[]" placeholder="Phone">
                                            </div>
                                            <div class="line">
                                                <input type="text" name="guestStreet[]" placeholder="Street">
                                                <input type="text" name="guestStreet1[]" placeholder="Street 1">

                            ...
                            <div class="form_wrapper">
                                            ...
                                            <table class="table" style="width: 100%">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><input type="time" name="arrival_time" id="" required></td>
                                                        <td><input type="date" name="departure_date" id="departure_date" required></td>
                                                        <td><input type="time" name="departure_time" id="" required></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                    ...
                                    <div class="guest-data">
                                        <div class="form_container_time">
                                            ...
                                            <table class="table">
                                                ...
                                                {{-- <button type="button" id="addnew"><i class="fa-solid fa fa-plus"></i> Add Row</button> --}}
                                                {{-- <tbody id="tbody">
                                                    <tr id="trow1">
                                                        <td rowspan="4" class="serialno text-left">1</td>
                                                        <td>
                                                            <tr>
                                                                <td><input type="text" name="guestName[]" id="guestName" placeholder="Name" class="text-left"></td>
                                                                <td><input type="text" name="guestSurName[]" id="guestSurName" placeholder="Surname" class="text-left"></td>
                                                                <td><input type="email" name="guestEmail[]" id="guestEmail" placeholder="Email" class="text-left"></td>
                                                                <td><input type="tel" name="guestPhone[]" id="guestPhone" placeholder="Phone" class="text-left"></td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="2"><input type="text" name="guestStreet[]" id="guestStreet" placeholder="Street" class="text-left"></td>
                                                                <td><input type="text" name="guestStreet1[]" id="guestStreet1" placeholder="Street 1" class="text-left"></td>
                                                                <td><input type="text" name="guestStreet2[]" id="guestStreet2" placeholder="Street 2" class="text-left"></td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="2"><input type="text" name="guestPostal[]" id="guestPostal" placeholder="Postal"></td>
                                                                <td><input type="text" name="guestCity[]" id="guestCity" placeholder="City"></td>
                                                                <td>
                                                                    <select name="guestCountry[]" id="country">
                                                        ...
                                                        <td rowspan="4">
                                                            <button type="button" class="deleteRow"><i class="fa fa-times" aria-hidden="true"></i> Remove</button>
                                                        </td>
                                                    </tr> --}}
                                                    ...
                                                    {{-- <tr id="trow">
                                                        ...
                                                        <td><input type="text" name="guestSurName[]" id="guestSurName"></td>
                                                        <td><input type="email" name="guestEmail[]" id="guestEmail"></td>
                                                        <td><input type="tel" name="guestPhone[]" id="guestPhone"></td><br><br>
                                                        <td><input type="text" name="guestStreet[]" id="guestStreet"></td>
                                                        <td><input type="text" name="guestStreet1[]" id="guestStreet1"></td>
                                                        <td><input type="text" name="guestStreet2[]" id="guestStreet2"></td>
                                                        <td><input type="text" name="guestPostal[]" id="guestPostal"></td>
                                                        <td><input type="text" name="guestCity[]" id="guestCity"></td>
                                                        <td>
                                                            <select name="guestCountry[]" id="country">
                                                                <option value="Afghanistan">Afghanistan</option>
                                                                <option value="Albania">Albania</option>
                                                        ...
                                                        <td class="btn-flex" class="deleteRow"><button type="button" ><i class="fa fa-times" aria-hidden="true"></i></button></td>
                                                    </tr> --}}
                                                {{-- </tbody> --}}
                                            </table>
                                        </div>
                                    ...
                                    <div class="unique_link" style="visibility: hidden">
                                        ...
                                        <div class="uniqueUrl">
                                            <div class="uniqueLinkIpt">
                                                <input id="uniqueLink" type="text" readonly name="uniqueLink">
                                            </div>
                                            <div class="CoptBtn">
                                    ...
                                    <div class="ownerRecContainer">
                                        <div class="ownerHeader">
                                            <div class="ownerUrlHead" style="visibility: hidden">
                                                <div>
                                                ...
                                                <div class="ownerDBtn">
                                                    <div>
                                                        <table class="detailOwner">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td><input type="text" class="ownLink" name="ownLink" id="ownLink"></td>
                                        ...
                                        <div class="sideRecep">
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody id="insbody">
                                                    <tr id="rowIns" class="rowIn text-left">
                                                        <td class="sNo text-left">1</td>
                                                        <td class="text-left"><input type="text" name="instruction[]" id="" required></td>
                                                        <td class="deleteIns text-left"><button type="button" class="btn btn-danger"><i class="fa fa-times" aria-hidden="true"></i> Remove</button></td>
                                                    </tr>
                                                </tbody>

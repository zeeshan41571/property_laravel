                    ...
                    <table class="table table-striped" width='100%'>
                        <thead>
                            <tr class="text-left">
                              ...
                              <th class="border text-left" style="text-align: left;">Arriavl</th>
                              <th class="border text-left" style="text-align: left;">Arriavl Time</th>
                              ...
                              <th class="border text-left" style="text-align: left;">Property</th>
                                ...
                                @foreach ($showUser as $guest)
                                    <tr>
                                        @php
                                            ...
                                            //dd($guest);
                                        @endphp
                                        <td class="border">{{ $guestsData['guests_data']['guest_1']['guestName'] }}</td>
                                        ...
                                        <td class="border">{{  $guest->property_id }}</td>
                                        <td class="border">

    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @if(Auth::user()->roles->contains('name', 'admin') || Auth::user()->roles->contains('name', 'staff'))
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                ...
                @endif
                @if(Auth::user()->roles->contains('name', 'admin') || Auth::user()->roles->contains('name', 'staff') || Auth::user()->roles->contains('name', 'owner'))
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">

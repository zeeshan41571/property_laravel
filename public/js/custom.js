$(document).ready(function () {
    ...
    $('#addnew').click(function () {
        rowNumber++;
        const newRow = `<tr>
                                    <td class="serialno">${rowNumber}</td>
                                    <td><input type="text" name="guestName[]" class="guestName"></td>
                                    <td><input type="text" name="guestSurName[]" class="guestSurName"></td>
                                    <td><input type="email" name="guestEmail[]" class="guestEmail"></td>
                                    <td><input type="tel" name="guestPhone[]" class="guestPhone"></td><br>
                                    <td><input type="text" name="guestStreet[]" class="guestStreet"></td>
                                    <td><input type="text" name="guestStreet1[]" class="guestStreet1"></td>
                                    <td><input type="text" name="guestStreet2[]" class="guestStreet2"></td>
                                    <td><input type="text" name="guestPostal[]" class="guestPostal"></td>
                                    <td><input type="text" name="guestCity[]" class="guestCity"></td>
                                    <td>
